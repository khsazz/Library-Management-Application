...
<head>
    ...
    <meta charset="UTF-8"/>
    <title>Library - Add New Student</title>
...
<div id="wrap">
    ...
    <div class="col-lg-10">
        <div class="panel panel-primary">
            <div class="panel-heading text-center"><h4>Add New Student</h4></div>
                            ...
                            <div id="collapseOne" class="accordion-body collapse in body">
                                <form action="<c:url value="/admin/saveStudent"/>" method="post" name="studentForm"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="digits" name="studentid" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="requi" name="name" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="email" id="required3" name="email" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="pa" name="phone" class="form-control"/>
                                        </div>
                                    </div>
